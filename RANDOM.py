	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AHSAM:
				...
				print('\r\r\033[1;31m[RIFAT-CP] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					...
					print('\r\r\x1b[1;92m[RIFAT-OK] '+ids+' | '+pas+'\033[1;97m')
	...
	try:
		...
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				print('\33[1;92m[RIFAT-OK] '+cid+' | '+ps+'\033[1;32m')
				...
				print('\x1b[38;5;208m[RIFAT-CP] '+cid+' | '+ps+'\33[0;97m')
